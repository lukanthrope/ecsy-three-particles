...
ParticleEmitterState.schema = Object.assign(Object.assign({}, ParticleEmitterState.schema), {
  emitter3D: {
    type: Types.Ref
  },
  useEntityRotation: {
...
ParticleEmitter.schema = Object.assign(Object.assign({}, ParticleEmitter.schema), {
  particleMesh: {
    type: Types.Ref,
    default: null
  },
...
function initializeParticleSystem(world, options = DEFAULT_OPTIONS) {
  ...
  world.registerSystem(ParticleSystem).registerComponent(ParticleEmitterState).registerComponent(ParticleEmitter);
